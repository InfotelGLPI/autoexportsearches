 ...
 * Class Exportconfig
 */
class Exportconfig extends CommonDBTM
{
        ...
        if ($search->getFromDB($export->fields['savedsearches_id'])) {
            ...
            foreach ($customCriterias as $customCriteria) {
                ...
                if (preg_match('/^-\d+MONTH$/', $criteria['value'])
                    && $customCriteria['criteria_value'] == Customsearchcriteria::CRITERIA_FIRST_DAY_OF_MONTH) {
                ...
                if (preg_match('/^-\d+WEEK$/', $criteria['value'])
                    && $customCriteria['criteria_value'] == Customsearchcriteria::CRITERIA_FIRST_DAY_OF_WEEK) {
