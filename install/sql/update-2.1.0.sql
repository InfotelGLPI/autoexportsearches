...
ALTER TABLE `glpi_plugin_autoexportsearches_exportconfigs` ADD `periodicity_type` int;
ALTER TABLE `glpi_plugin_autoexportsearches_exportconfigs` ADD `periodicity_open_days` tinyint;

UPDATE `glpi_plugin_autoexportsearches_exportconfigs` SET `periodicity_type` = 0 WHERE 1;
UPDATE `glpi_plugin_autoexportsearches_exportconfigs` SET `periodicity_open_days` = 0 WHERE 1;
